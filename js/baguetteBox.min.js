...
!(function (e, t) {
	...
	'function' == typeof define && define.amd
		? define(t)
		: 'object' == typeof exports ? (module.exports = t()) : (e.baguetteBox = t());
})(this, function () {
	'use strict';
	var r,
		l,
		...
		N = function (e) {
			if (!a && !i.multitouch) {
				...
				40 < t.pageX - i.startX
					? ((a = !0), D())
					: t.pageX - i.startX < -40 ? ((a = !0), X()) : 100 < i.startY - t.pageY && j();
			}
		},
		L = function () {
				...
				h = e,
					(function s (e) {
						...
						(l.style.transition = l.style.webkitTransition =
							'fadeIn' === b.animation ? 'opacity .4s ease' : 'slideIn' === b.animation ? '' : 'none'),
	...
	function I (e) {
		b.noScrollbars &&
			((document.documentElement.style.overflowY = 'hidden'), (document.body.style.overflowY = 'scroll')),
			...
			run          : function K (e, t) {
				return (
					(m.transforms = (function n () {
						var e = J('div');
						return (
							'undefined' != typeof e.style.perspective || 'undefined' != typeof e.style.webkitPerspective
						);
					})()),
					(m.svg = (function o () {
						var e = J('div');
